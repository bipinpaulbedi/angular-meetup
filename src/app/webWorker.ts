export class WebWorkerService {
    ...
    // ************************************************************** External Services
    protected run<T>(workerFunction: (input: any) => T, data?: any): Promise<T> {
    ...
    // ************************************************************** Internal Service
    private runUrl(url: string, data?: any): Promise<any> {
    ...
    private getWorker(promise: Promise<any>): Worker {
